...
export function ChartLineValue({datas , setTypeId  , TypeId, animation , setPriceUnitId , PriceUnitId , setLength , Length }) {
        ...
        <div id="chartArea" className="col-xl-12 layout-spacing">
            <div className="widget widget-chart-three">
                <div className="widget-heading ">
                    ...
                    <div className="d-inline float-left px-2">
                    <span >{Length  + " "+ ScheduleTypes.filter((i)=> i.value === `${TypeId}`).map((i)=> i.label) + " "+ "اخیر"}
                 { " " }
                    در مقیاس   
                    { " " }
                                ...
                                <div className='col-lg-4  mt-4 textOnInput form-group' >
                                    <div className=" form-control-sm">
                                        ...
                                        <Select
                                            ...
                                            defaultValue={ComboPrice().filter((i)=> i.value === PriceUnitId).map((i)=> i)}

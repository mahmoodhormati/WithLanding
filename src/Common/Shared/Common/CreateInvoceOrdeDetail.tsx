...
interface Props {
    modalIsOpen: any, closeModal: any, orderDetailId: any, Order: any, defaultPaymentId: any,updateDetails:any

}
const CraeteInvoceOrderDetail: React.FC<Props> = ({ modalIsOpen, closeModal, orderDetailId, Order, defaultPaymentId,updateDetails }) => {

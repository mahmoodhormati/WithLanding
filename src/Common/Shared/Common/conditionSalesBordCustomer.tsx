    ...
    return ( <Fragment>
        ...
        <div className=" containerT p-2">
            ...
            <table
                ...
                <tbody>
                    {productSupplyConditions ? productSupplyConditions.productSupplyConditions.filter((i:any)=>i.special===false ).filter((b:any)=>b.active===true  ).map((contact:any, index:number) =>
...
<td data-th="فی">{formatter.format( contact.price)}</td>

...
const ContainerTypeI = ({ height,data }) => {
    return (
        ...
        <div className='row p-2 ' style={{ height: `70%` }}>
                ...
                <div className="col-4   defaultHeight2Col mt-1 ">
                    <div  id={`${data.componentDetails && data.componentDetails[3]?`CMPD${data.componentDetails[3].id}`:''}`}  className="col-12 defaultBakground  defaultHeight1Col ">

                    </div>
                </div>
                <div className="col-4   defaultHeight2Col mt-1 ">
                    <div  id={`${data.componentDetails && data.componentDetails[4]?`CMPD${data.componentDetails[4].id}`:''}`}  className="col-12 defaultBakground  defaultHeight1Col ">

                    </div>
                </div>
                <div className="col-4   defaultHeight2Col mt-1">
                    <div  id={`${data.componentDetails && data.componentDetails[5]?`CMPD${data.componentDetails[5].id}`:''}`}  className="col-12 defaultBakground  defaultHeight1Col ">

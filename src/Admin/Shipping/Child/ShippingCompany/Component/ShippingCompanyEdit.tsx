...
const EditShippingCompany: React.FC = () => {
    ...
    const GetShippingcompany = async () => {
        ...
        SetshippingCompanySourceId(data.result.shippingCompany.shippingCompanySourceId)
        Setcomment(data.result.shippingCompany.comment)
    }
    ...
    const submit = async () => {
        const ShippingCompany = {
            "shippingCompany": {
                ...
                code,
                active: check,
                comment:comment, shippingCompanySourceId

...
const ShippingContractAttachmnet: React.FC<Props> = ({ order, params, modalIsOpenUpload, closeModalForUpload, setIsOpenUpload }) => {
            ...
            <section className="mb-2  ">
                <div className=" mb-1    rounded ">
                    <div className="row p-3 itemA">
                        <div className=" col-6  ">
                            <span className="float-left">اسناد قرارداد </span>
                        ...
                        <div className="info-Item">
                            ...
                            <div className="form-group mb-4 textOnInput col-lg-12 rounded border text-center border-dark  mt-4 p-2">
                                                    ...
                                                    {item.attachmentTypeId === 2 ?
                                                        ...
                                                        : item.attachmentTypeId === 1 ?
                                                            ...
                                                            : item.attachmentTypeId === 0 ?
                                                                <>
                                                                    <h4 className="text-dark">سند قرارداد </h4>
                                                                </> :
                                                                ''}
                                                </div>
                                ...
                                <div className='  '>
                                    ...
                                    <ImageFileUploader modalIsOpen={modalIsOpenUpload} closeModal={closeModalForUpload} EntityId={params.id} EntityTypesId={17} comment={'لطفا فایل  مورد نظر را بارگزاری کنید.'} AttchmentTypeId={0} />
...
export default ShippingContractAttachmnet
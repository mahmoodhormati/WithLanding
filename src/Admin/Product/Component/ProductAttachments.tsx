...
const ProductAttachments: React.FC<Props> = ({ order, params, modalIsOpenUpload, closeModalForUpload, setIsOpenUpload }) => {
            ...
            <section className="mb-2  ">
                <div className=" mb-1    rounded ">
                    <div className="row p-3 itemA">
                        <div className=" col-6  ">
                            <span className="float-left"> تصاویر کلا</span>
                            ...
                            <div className="form-group mb-4 textOnInput col-lg-12 rounded border text-center border-dark  mt-4 p-2">
                                <div className="text-center">
                                    <div className=" row text-center ">
                                        {newAttachment.map((item: any,index) =>
                                                    ...
                                                    {item.attachmentTypeId === 2 ?
                                                        ...
                                                        : item.attachmentTypeId === 1 ?
                                                            ...
                                                            : item.attachmentTypeId === 0 ?
                                                                <>
                                                                    <h5 className="text-dark">{`عکس شماره ${index+1} `}  </h5>
                                                                </> :
                                                                ''}
                                                </div>
                                ...
                                <div className='  '>
                                    ...
                                    <ImageFileUploader modalIsOpen={modalIsOpenUpload} closeModal={closeModalForUpload} EntityId={params.id} EntityTypesId={2} comment={'لطفا فایل  مورد نظر را بارگزاری کنید.'} AttchmentTypeId={0} />
        ...
        return (
            <section className="mb-2 mt-2">
                <div className=" mb-1    rounded ">
                    <div className="row p-3 itemA">
                        <div className=" col-6  ">
                        <span className="float-left">تصاویر کالا</span>

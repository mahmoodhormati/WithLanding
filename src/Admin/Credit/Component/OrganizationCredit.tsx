...
const OrganizationCredit: React.FC<Props> = ({ data, getData, creditId,value }) => {
    ...
    return (
        <div>
            ...
            <div className="form-group mb-4 textOnInput col-lg-12 rounded border mainMenu border-dark  mt-4 p-2">
                ...
                <div className='  '>
                    ...
                    <button style={{ marginTop: '-.8rem', marginLeft: '.6rem', background: 'white' }} className=" border-0 Attachment   float-right " title="افزودن سازمان" onClick={OpenAddModal} >
                    ...
                    <EditMemberOfCredit modalIsOpen={IsOpenEdit} closeModal={CloseEditModal} EntityType={3} Credit={getData} creditId={creditId} currentItem={currentItem} value={value}/>
...
export default OrganizationCredit
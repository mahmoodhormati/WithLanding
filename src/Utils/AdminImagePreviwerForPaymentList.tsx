        ...
        >
            ...
            <div id="gallery-container" >
                <div className="gallery-img-container ">
                    ...
                    {image ?
                        <img src={`${attachmet}${image.path}`} className="gallery-img" alt={image.name} style={{ transform: `rotate(${rotate}deg)` }} />
            ...
            {image ? <div className='d-flex justify-content-around mb-2 mt-2'>
...
export default AdminImagePreviwerForPaymentList